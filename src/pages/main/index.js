        ...
        <Switch>
          ...
          <Route>
            <Layout className={css.main_page}>
              <Sider theme="light" collapsible={true} collapsed={this.state.collapsed} onCollapse={this.onCollapse}>
                ...
                <Menu mode="inline" selectedKeys={[getCurrentMenuKey()]} className={css.sider_menu}>
                  <Menu.Item key={navPath.HOME}>
                    <HomeOutlined />
                    <span>
                      <Link to={navPath.HOME}>Home</Link>
                    </span>
                  </Menu.Item>
                  <Menu.Item key={navPath.EXAMPLE}>
                    <DesktopOutlined />
                    <span>
                      <Link to={navPath.EXAMPLE}>example</Link>
                    </span>
                  </Menu.Item>
                  <SubMenu
                    key="sub1"
                  ...
                  >
                    <Menu.Item key={navPath.SUB_PAGE}>
                      <DesktopOutlined />
                      <span>
                        <Link to={navPath.SUB_PAGE}>sub page</Link>
                      </span>
                    </Menu.Item>
                  </SubMenu>
                </Menu>
